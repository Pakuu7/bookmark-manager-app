...
export function showBookmarks(list: Bookmark[]) {
    ...
    list.forEach(bookmark => {
        ...
        card.innerHTML = `
        <div class="top flex justify-between items-start pb-3 p-4 border-b border-b-neutral-300">
                <div class="flex gap-4 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-preset-5 text-neutral-800">${displayUrl}</p>
                    </div>
                </div>
                <button class="border border-neutral-400 p-1 rounded-lg cursor-pointer">
